...
class Counterexample:
    ...
    def __init__(self, nusmv_result: str, robot_len=5):
    ...
    def set_plot_limits(self, lim):
        self.lim = lim

    def plot_trace(self, robot_step=0, save_path="3d_plot.png", show_plot=False):
        ...
        ax.set_xlim(-self.lim, self.lim)  # X axis range
        ax.set_ylim(-self.lim, self.lim)  # Y axis range
        ax.set_zlim(0, 2 * self.lim)  # Z axis range
    ...
    @staticmethod
    def run_nusmv(smv_file="./smv/robot_structure.smv"):
