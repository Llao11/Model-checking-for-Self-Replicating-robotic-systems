...
class SRRSsensorsNode(Node):
    ...
    def set_contact1_state(self, msg: Contacts):
        ...
        # self.get_logger().info(f"Collision between
        # {contact_msg.collision1.name.split("_")[0]} and {contact_msg.collision2.name}")
    ...
    def set_contact2_state(self, msg: Contacts):
        contact_msg = msg.contacts[0]
        # self.get_logger().info(f"Collision between {contact_msg.collision1.name.split("_")[0]}
        # and {contact_msg.collision2.name}")
    ...
    #     if msg.linear_acceleration.x > 0.01 or msg.linear_acceleration.y > 0.01
    # or msg.linear_acceleration.z-9.81 > 0.01 :
    #         self.get_logger().info(f"Velocity: {msg.linear_acceleration.x}
    # \t {msg.linear_acceleration.y} \t {msg.linear_acceleration.z-9.81}")
