...
class Configuration_checking_aggregated:
    def __init__(
        self,
        length,
        block_types,
        target: list,
        template_smv="./smv/robot_structure_aggregated_template.smv",
        output_smv_path="./tmp/",
    ):
    ...
    def start_checking_combinations(self):
        ...
        for configuration in self.combinations:
            ...
            generator = RobotNusmvGenerator(robot, template_smv=self.template)
...
if __name__ == "__main__":
    ...
    for length in range(3, 4):
        ...
        config_checking = Configuration_checking_aggregated(length, block_types, target)
